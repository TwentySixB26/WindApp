<form method="post" action="/profile/{{ $user->username }}" enctype="multipart/form-data">
    ...
    <div class="space-y-12 mt-6">
        {{-- head  --}}
        <div class=" pb-6 justify-center flex flex-col items-center">
            <h2 class="font-firaSans text-slate-800 text-xl font-medium italic">Edit Your Profile</h2>
            <div class=" max-w-[20%] mt-3 relative">

                {{-- img --}}
                <div class="w-[120px]  h-[120px] object-center rounded-full overflow-hidden">
        ...
        <div class="border-b border-gray-900/10 pb-12">
            <div class=" grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    <label for="Username" class="block text-sm/6 font-medium text-gray-900 italic">Username : </label>
                    <div class="mt-2 ">
                ...
                {{-- name --}}
                <div class="sm:col-span-3">
                    <label for="Name" class="block text-sm/6 font-medium text-gray-900 italic">Name : </label>
                    <div class="mt-2">
            ...
            <div class="mt-20 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        <label for="bio" class="block text-sm/6 font-medium text-gray-900 italic">Bio:</label>
                        <div class="mt-2">
