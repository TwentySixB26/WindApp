    ...
    {{-- status  --}}
        ...
        <div class="mt-10 lg:mt-14">
            ...
            <form action="/statuses/{{ $status->id }}/coment" method="post">
                @csrf
                <textarea id="coment" cols="30" rows="10" name="coment" class="w-full  h-[40px] p-2 px-0 border-b border-slate-950  outline-none active:border-b text-[0.65rem] sm:text-sm lg:text-sm resize-none " placeholder="Post your coment" required></textarea>
